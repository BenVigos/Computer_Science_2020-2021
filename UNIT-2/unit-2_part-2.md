...
| 2        | Use left button to enter input. Short press for dot and long press for dash. Press the right button to translate the letter (right button pressed after every grouping) | 3. 3- 3. | "SOS" on screen" | Must allow the user to enter either morse code and output to English            | Yes |
